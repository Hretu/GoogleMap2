...
public class Search extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    etCity.setError("Enter a Place Name Please");
                    return;
                }
                ...
                if(position>-1)
                    ...
                    Toast.makeText(Search.this,"location not found by name : "
    ...
    private void fillArrayListAndSetAdapter()
    {
        ...
        latitudeLongitudeList.add(new LatitudeLongitude(27.7134481,85.3241992,"Naagpokhari"));
        latitudeLongitudeList.add(new LatitudeLongitude(27.7181749,85.3173212,"Narayanhiti Palace Museuem"));
...
public int SearchArrayList(String name){
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        center= CameraUpdateFactory.newLatLng(new LatLng(27.712453,85.3239605));
